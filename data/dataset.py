...
class FIFASequenceDataset(Dataset):
    def __init__(self, data_dir, match_files, target_frames=100):
        ...
        # Coarse (dense) label for contrastive training -- the full label is
        # too sparse (near-unique per play) to train SupCon on.
    ...
    def __getitem__(self, idx):
        ...
        # Build (is_home, is_away) to go from 7 -> 9 feature channels.
        # Index convention: 0 = Ball, 1:12 = Home, 12:23 = Away
